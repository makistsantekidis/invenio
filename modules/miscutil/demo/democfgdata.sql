...
INSERT INTO sbmFIELDDESC VALUES ('DEMOTHE_AU',NULL,'100__a','R',NULL,6,60,NULL,NULL,'from invenio.websubmit_engine import get_author_autocompletion_form, prepare_author_sources, convert_record_authors_to_json\r\n\r\nprepare_author_sources(curdir, [\'bibauthority\'])\r\n\r\nextra_fields = {\'contribution\': True}\r\nallow_custom_authors = True\r\n\r\nif action == \'MBI\':\r\n     element[\'value\'] = convert_record_authors_to_json(sysno)\r\n\r\nif \'curdir\' in globals():\r\n    text = get_author_autocompletion_form(element, curdir=curdir, doctype=doctype, access=access, allow_custom_authors=allow_custom_authors, extra_fields=extra_fields)\r\nelif \'indir\' in globals():\r\n    text = get_author_autocompletion_form(element, indir=indir, doctype=doctype, access=access, allow_custom_authors=allow_custom_authors, extra_fields=extra_fields)\r\nelse:\r\n    text = \"\"\r\n','2008-03-02','2014-06-30','<br />Authors:<br />(one per line):<br />',NULL,0);
...
INSERT INTO sbmFUNCTIONS VALUES ('SBI','DEMOTHE','Convert_Field_from_Json',50,1);
...
INSERT INTO sbmFUNCTIONS VALUES ('MBI','DEMOTHE','Create_Modify_Interface',50,1);
INSERT INTO sbmFUNCTIONS VALUES ('MBI','DEMOTHE','Convert_Field_from_Json',40,1);
