...
def get_wiki_link_from_bfo(bfo):
    ...
    for field in fields:
        if type(field) is dict:
            if field.get(CFG_VIAF_WIKIPEDIA_NAME_LABEL_SUBFIELD,None) == CFG_VIAF_WIKIPEDIA_NAME_VALUE_SUBFIELD:
            ...
            if record_dict.get(CFG_VIAF_WIKIPEDIA_NAME_LABEL_SUBFIELD,None) == CFG_VIAF_WIKIPEDIA_NAME_VALUE_SUBFIELD:
