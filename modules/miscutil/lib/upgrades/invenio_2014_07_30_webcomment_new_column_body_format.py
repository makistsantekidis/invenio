...
def do_upgrade():
    ...
    if number_of_comments > 0:
        ...
        select_batch_size = number_of_comments >= ( number_of_select_batches * number_of_select_batches ) and \
                            number_of_comments / number_of_select_batches or \
                            number_of_comments

        number_of_select_iterations = number_of_select_batches + \
        ...
        for number_of_select_iteration in xrange(number_of_select_iterations):
            ...
            comments = run_sql(
                ...
                (number_of_select_iteration * select_batch_size, select_batch_size)
            )
