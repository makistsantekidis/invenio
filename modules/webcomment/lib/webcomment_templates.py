...
''' % {'url': url,
    ...
    def tmpl_email_new_comment_header(
        ...
        if html_p:
            out = out.replace('\n','<br />')
            # TODO: should the style information be added here or is added again later?
            out += '<style>blockquote {padding: 0px 10px 0px 10px; border-left: 2px solid #3366CC; margin: 0px 0px 0px 10px;}</style>'
